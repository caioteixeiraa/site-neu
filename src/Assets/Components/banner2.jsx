        ...
        return (
            <div className="home-banner-2">
                ...
                <div className="container banner-content">
                    ...
                    <a href={this.props.linkbotao} target="_blank"><button type="button col-lg-6 col-md-6 col-sm-8 col-xs-2" className="button-secondary-banner center">{this.props.conteudobotao}</button></a>
                </div>
            </div>
        )
    }
