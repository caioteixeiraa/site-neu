            ...
            <div className="card-depo col-md-3 margin-right-2em top-amarelo">
                ...
                <div className="padding-depo">
                    <div className="content-depo">
                        <p className="texto-depo">"Sempre gostei de ter o NEU por perto. A influência do núcleo na universidade é muito grande, e consegue atrair talentos incríveis. O NEU ajudou a preencher algumas vagas na 99 e, agora na Yellow, selecionamos o Diego que veio para o time de dados impressionando desde a entrevista. Melhor fit, impossível :)" </p>
