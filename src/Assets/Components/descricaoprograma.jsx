        ...
        return (
            <div className="bloco container">
                ...
                <div className="botoes row">
                    <a href={this.props.link_primeirobotao} target=""><button type="button col-lg-6 col-md-6 col-sm-8 col-xs-2" className="button-primary" href="#">{this.props.btnprimary}</button></a>
                    <a href={this.props.link_segundobotao} target=""><button type="button col-lg-6 col-md-6 col-sm-8 col-xs-2" className="button-secondary">{this.props.btnsecondary}</button></a>
                </div>
            </div>
        )
    }
